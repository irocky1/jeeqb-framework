...
import org.jeeqb.framework.mvc.bean.Multipart;
import org.jeeqb.framework.mvc.bean.Multiparts;
import org.jeeqb.framework.mvc.bean.RequestParams;
import org.jeeqb.framework.mvc.fault.UploadException;
import org.jeeqb.framework.util.FileUtil;
import org.jeeqb.framework.util.StreamUtil;
...
public class UploadHelper {
    ...
    public static void init(ServletContext servletContext) {
        ...
        // 设置上传限制
        int uploadLimit = JEEQB.UPLOAD_LIMIT;
        if (uploadLimit != 0) {
    ...
    public static List<Object> createMultipartParamList(HttpServletRequest request) throws Exception {
        ...
        for (FileItem fileItem : fileItemList) {
            ...
            if (fileItem.isFormField()) {
                // 处理普通字段
            String fieldValue = fileItem.getString(JEEQB.UTF_8);
        ...
        // 初始化参数列表
        paramList.add(new RequestParams(fieldMap));
