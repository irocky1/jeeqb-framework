...
import org.jeeqb.framework.util.CodecUtil;
...
public class WebContext {
    ...
    /**
     * 每个线程拥有自己的WebContext实例
     */
    private final static ThreadLocal<WebContext> webContextContainer = new ThreadLocal<>();
    ...
    public static void init(HttpServletRequest request,HttpServletResponse response){
        ...
        webContextContainer.set(context);
    }
