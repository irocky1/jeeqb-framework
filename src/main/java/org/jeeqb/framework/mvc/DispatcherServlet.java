...
public class DispatcherServlet extends HttpServlet{
    ...
    private HandlerMapping handlerMapping = InstanceContext.getHandlerMapping();
    private HandlerInvoker handlerInvoker = InstanceContext.getHandlerInvoker();
    private HandlerExceptionResolver handlerExceptionResolver = InstanceContext.getHandlerExceptionResolver();

    @Override
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        // 设置请求编码方式
        request.setCharacterEncoding(JEEQB.UTF_8);
        // 获取当前请求相关数据
