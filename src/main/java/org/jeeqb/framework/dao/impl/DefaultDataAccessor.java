package org.jeeqb.framework.dao.impl;
...
/**
 * 默认数据访问器
 * 基于Apache commons DbUtils实现
 *
 * Created by rocky on 2018/3/19.
 */
public class DefaultDataAccessor implements DataAccessor {

    private final static Logger logger = LoggerFactory.getLogger(DefaultDataAccessor.class);
